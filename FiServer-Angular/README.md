...
app/                    --> all of the source files for the application
  ...
  view1/                --> the view1 view template and logic
    ...
    todasLasNotas.js              --> the controller logic
    todasLasNotas_test.js         --> tests of the controller
  view2/                --> the view2 view template and logic
    view2.html            --> the partial template
    compartidas.js              --> the controller logic
    compartidas_test.js         --> tests of the controller
